...
pub async fn get_budget_by_id(configuration: &configuration::Configuration, budget_id: &str, last_knowledge_of_server: Option<i64>) -> Result<crate::models::BudgetDetailResponse, Error<GetBudgetByIdError>> {
...
pub async fn get_budget_settings_by_id(configuration: &configuration::Configuration, budget_id: &str) -> Result<crate::models::BudgetSettingsResponse, Error<GetBudgetSettingsByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_budgets(configuration: &configuration::Configuration, include_accounts: Option<bool>) -> Result<crate::models::BudgetSummaryResponse, Error<GetBudgetsError>> {
    let local_var_configuration = configuration;
