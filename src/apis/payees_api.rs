...
pub async fn get_payee_by_id(configuration: &configuration::Configuration, budget_id: &str, payee_id: &str) -> Result<crate::models::PayeeResponse, Error<GetPayeeByIdError>> {
...
/// Returns all payees
pub async fn get_payees(configuration: &configuration::Configuration, budget_id: &str, last_knowledge_of_server: Option<i64>) -> Result<crate::models::PayeesResponse, Error<GetPayeesError>> {
    let local_var_configuration = configuration;
