...
pub async fn get_payee_location_by_id(configuration: &configuration::Configuration, budget_id: &str, payee_location_id: &str) -> Result<crate::models::PayeeLocationResponse, Error<GetPayeeLocationByIdError>> {
...
pub async fn get_payee_locations(configuration: &configuration::Configuration, budget_id: &str) -> Result<crate::models::PayeeLocationsResponse, Error<GetPayeeLocationsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_payee_locations_by_payee(configuration: &configuration::Configuration, budget_id: &str, payee_id: &str) -> Result<crate::models::PayeeLocationsResponse, Error<GetPayeeLocationsByPayeeError>> {
    let local_var_configuration = configuration;
