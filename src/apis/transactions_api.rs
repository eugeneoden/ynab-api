...
pub async fn create_transaction(configuration: &configuration::Configuration, budget_id: &str, data: crate::models::SaveTransactionsWrapper) -> Result<crate::models::SaveTransactionsResponse, Error<CreateTransactionError>> {
...
pub async fn get_transaction_by_id(configuration: &configuration::Configuration, budget_id: &str, transaction_id: &str) -> Result<crate::models::TransactionResponse, Error<GetTransactionByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transactions(configuration: &configuration::Configuration, budget_id: &str, since_date: Option<String>, _type: Option<&str>, last_knowledge_of_server: Option<i64>) -> Result<crate::models::TransactionsResponse, Error<GetTransactionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transactions_by_account(configuration: &configuration::Configuration, budget_id: &str, account_id: &str, since_date: Option<String>, _type: Option<&str>, last_knowledge_of_server: Option<i64>) -> Result<crate::models::TransactionsResponse, Error<GetTransactionsByAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transactions_by_category(configuration: &configuration::Configuration, budget_id: &str, category_id: &str, since_date: Option<String>, _type: Option<&str>, last_knowledge_of_server: Option<i64>) -> Result<crate::models::HybridTransactionsResponse, Error<GetTransactionsByCategoryError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transactions_by_payee(configuration: &configuration::Configuration, budget_id: &str, payee_id: &str, since_date: Option<String>, _type: Option<&str>, last_knowledge_of_server: Option<i64>) -> Result<crate::models::HybridTransactionsResponse, Error<GetTransactionsByPayeeError>> {
    let local_var_configuration = configuration;
...
pub async fn import_transactions(configuration: &configuration::Configuration, budget_id: &str) -> Result<crate::models::TransactionsImportResponse, Error<ImportTransactionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_transaction(configuration: &configuration::Configuration, budget_id: &str, transaction_id: &str, data: crate::models::SaveTransactionWrapper) -> Result<crate::models::TransactionResponse, Error<UpdateTransactionError>> {
    let local_var_configuration = configuration;
...
pub async fn update_transactions(configuration: &configuration::Configuration, budget_id: &str, data: crate::models::UpdateTransactionsWrapper) -> Result<crate::models::SaveTransactionsResponse, Error<UpdateTransactionsError>> {
    let local_var_configuration = configuration;
